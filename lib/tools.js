...
export function createTools(options) {
  ...
  return {
    ...
    kapsel_rpc: define('Invoke one dynamic read-only RPC operation on a mapping. First inspect kapsel_mappings capabilities.rpc.<family>.description and operation_specs.<operation>.description/input_schema; future doc/csv/sqlite plugins require no new OpenCode tool. No Plan/write approval or server/FUSE fallback.', {
